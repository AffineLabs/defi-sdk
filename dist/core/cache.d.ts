 ...
 */
export declare function getAllContracts(provider: ethers.providers.JsonRpcProvider, version: string): Promise<PolygonContracts | EthContracts>;
export declare function getContracts(): PolygonContracts | EthContracts;
