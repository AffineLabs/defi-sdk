...
export declare function buyProduct(
  product: AlpineProduct,
  amount: number,
  slippageBps?: number,
): Promise<DryRunReceipt | undefined>;
...
export declare function buyBtCEthShares(
  amountUSDC: number,
  slippageBps: number,
...
export declare function tokensFromShares(
  product: AlpineProduct,
  shareAmount: ethers.BigNumber,
): Promise<ethers.BigNumber>;
export declare function sharesFromTokens(
  product: AlpineProduct,
