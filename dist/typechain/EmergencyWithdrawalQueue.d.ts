...
export interface EmergencyWithdrawalQueueInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "dequeueBatch", values: [PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "enqueue", values: [
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<BigNumberish>
    ]): string;
    encodeFunctionData(functionFragment: "headPtr", values?: undefined): string;
    encodeFunctionData(functionFragment: "ownerToDebt", values: [PromiseOrValue<string>]): string;
...
export interface EmergencyWithdrawalQueue extends BaseContract {
    ...
    functions: {
        ...
        dequeueBatch(batchSize: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        enqueue(owner: PromiseOrValue<string>, receiver: PromiseOrValue<string>, shares: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        headPtr(overrides?: CallOverrides): Promise<[BigNumber]>;
        ownerToDebt(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    callStatic: {
        ...
        dequeueBatch(batchSize: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        enqueue(owner: PromiseOrValue<string>, receiver: PromiseOrValue<string>, shares: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        headPtr(overrides?: CallOverrides): Promise<BigNumber>;
        ownerToDebt(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        shareDebt(overrides?: CallOverrides): Promise<BigNumber>;
        size(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    filters: {
        "Pop(uint256,address,address,uint256)"(pos?: PromiseOrValue<BigNumberish> | null, owner?: PromiseOrValue<string> | null, receiver?: PromiseOrValue<string> | null, shares?: null): PopEventFilter;
        Pop(pos?: PromiseOrValue<BigNumberish> | null, owner?: PromiseOrValue<string> | null, receiver?: PromiseOrValue<string> | null, shares?: null): PopEventFilter;
        "Push(uint256,address,address,uint256)"(pos?: PromiseOrValue<BigNumberish> | null, owner?: PromiseOrValue<string> | null, receiver?: PromiseOrValue<string> | null, shares?: null): PushEventFilter;
        Push(pos?: PromiseOrValue<BigNumberish> | null, owner?: PromiseOrValue<string> | null, receiver?: PromiseOrValue<string> | null, shares?: null): PushEventFilter;
    };
    estimateGas: {
        dequeue(overrides?: Overrides & {
            from?: PromiseOrValue<string>;
    ...
    populateTransaction: {
        ...
        ownerToDebt(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
