...
export interface ForwarderInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "executeBatch", values: [MinimalForwarder.ForwardRequestStruct[], PromiseOrValue<BytesLike>]): string;
...
export interface Forwarder extends BaseContract {
    ...
    functions: {
        ...
        executeBatch(requests: MinimalForwarder.ForwardRequestStruct[], signatures: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        executeBatch(requests: MinimalForwarder.ForwardRequestStruct[], signatures: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        getNonce(from: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        verify(req: MinimalForwarder.ForwardRequestStruct, signature: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {};
