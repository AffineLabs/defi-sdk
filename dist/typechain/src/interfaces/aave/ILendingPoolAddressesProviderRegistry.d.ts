...
export interface ILendingPoolAddressesProviderRegistryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getAddressesProviderIdByAddress" | "getAddressesProvidersList" | "registerAddressesProvider" | "unregisterAddressesProvider"): FunctionFragment;
...
export interface ILendingPoolAddressesProviderRegistry extends BaseContract {
    ...
    filters: {
        "AddressesProviderRegistered(address)"(newAddress?: PromiseOrValue<string> | null): AddressesProviderRegisteredEventFilter;
        AddressesProviderRegistered(newAddress?: PromiseOrValue<string> | null): AddressesProviderRegisteredEventFilter;
        "AddressesProviderUnregistered(address)"(newAddress?: PromiseOrValue<string> | null): AddressesProviderUnregisteredEventFilter;
