...
export interface IMasterChefInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "deposit(uint256,uint256,address)" | "deposit(uint256,uint256)" | "poolInfo" | "poolLength" | "totalAllocPoint" | "updatePool" | "userInfo" | "withdraw" | "withdrawAndHarvest"): FunctionFragment;
