...
import type { L2USDEarnVault, L2USDEarnVaultInterface } from "../L2USDEarnVault";
export declare class L2USDEarnVault__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): L2USDEarnVault;
}
