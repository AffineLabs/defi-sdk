...
import type { DegenVaultV2Eth, DegenVaultV2EthInterface } from "../DegenVaultV2Eth";
export declare class DegenVaultV2Eth__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): DegenVaultV2Eth;
}
