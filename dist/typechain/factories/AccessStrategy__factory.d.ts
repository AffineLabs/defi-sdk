...
import type { AccessStrategy, AccessStrategyInterface } from "../AccessStrategy";
export declare class AccessStrategy__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): AccessStrategy;
}
