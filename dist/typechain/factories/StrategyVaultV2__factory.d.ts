...
import type { StrategyVaultV2, StrategyVaultV2Interface } from "../StrategyVaultV2";
export declare class StrategyVaultV2__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): StrategyVaultV2;
}
