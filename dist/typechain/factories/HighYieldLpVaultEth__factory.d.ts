...
import type { HighYieldLpVaultEth, HighYieldLpVaultEthInterface } from "../HighYieldLpVaultEth";
export declare class HighYieldLpVaultEth__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): HighYieldLpVaultEth;
}
