...
import type { BeefyEpochStrategy, BeefyEpochStrategyInterface } from "../BeefyEpochStrategy";
export declare class BeefyEpochStrategy__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): BeefyEpochStrategy;
}
