...
import type { StakingExp, StakingExpInterface } from "../StakingExp";
export declare class StakingExp__factory {
    ...
    static createInterface(): StakingExpInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): StakingExp;
}
