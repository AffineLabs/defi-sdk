...
import type { L2AAVEStrategy, L2AAVEStrategyInterface } from "../L2AAVEStrategy";
export declare class L2AAVEStrategy__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): L2AAVEStrategy;
}
