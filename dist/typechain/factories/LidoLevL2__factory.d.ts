...
export declare class LidoLevL2__factory {
    static readonly abi: readonly [{
        ...
        readonly inputs: readonly [{
            readonly internalType: "contract LidoLevL2";
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): LidoLevL2;
}
