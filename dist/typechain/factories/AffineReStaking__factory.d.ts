...
import type { AffineReStaking, AffineReStakingInterface } from "../AffineReStaking";
export declare class AffineReStaking__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): AffineReStaking;
}
