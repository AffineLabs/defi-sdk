...
import type { MockEpochStrategy, MockEpochStrategyInterface } from "../MockEpochStrategy";
export declare class MockEpochStrategy__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): MockEpochStrategy;
}
