...
export declare class L1Vault__factory {
    static readonly abi: readonly [{
        ...
        readonly inputs: readonly [{
            ...
            readonly indexed: false;
            readonly internalType: "uint256";
            readonly name: "assetsSent";
            readonly type: "uint256";
        }];
        readonly name: "TransferToL2";
        readonly type: "event";
    }, {
        readonly anonymous: false;
        readonly inputs: readonly [{
        ...
        readonly inputs: readonly [{
            ...
            readonly internalType: "contract L1BridgeEscrow";
            readonly name: "_bridgeEscrow";
            readonly type: "address";
        }, {
            readonly internalType: "contract IRootChainManager";
            readonly name: "_chainManager";
            readonly type: "address";
        }, {
            readonly internalType: "address";
            readonly name: "_predicate";
            readonly type: "address";
        }];
        ...
        readonly name: "processFundRequest";
        readonly outputs: readonly [];
        readonly stateMutability: "nonpayable";
        readonly type: "function";
    }, {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): L1Vault;
}
