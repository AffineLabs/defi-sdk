...
export declare class LidoLev__factory {
    static readonly abi: readonly [{
        readonly inputs: readonly [{
            readonly internalType: "contract LidoLev";
            readonly name: "oldStrat";
        ...
        readonly inputs: readonly [];
        readonly name: "JOIN_DAI";
        readonly outputs: readonly [{
            readonly internalType: "contract IGemJoin";
            readonly name: "";
            readonly type: "address";
        }];
        readonly stateMutability: "view";
        ...
        readonly name: "MAKER";
        readonly outputs: readonly [{
            readonly internalType: "contract ICdpManager";
            readonly name: "";
            readonly type: "address";
        }];
        readonly stateMutability: "view";
        ...
        readonly name: "VAT";
        readonly outputs: readonly [{
            readonly internalType: "contract IVat";
            readonly name: "";
            readonly type: "address";
        }];
        readonly stateMutability: "view";
        ...
        readonly inputs: readonly [{
            readonly internalType: "uint256";
            readonly name: "ethToBorrow";
            readonly type: "uint256";
        }];
        readonly name: "createCompoundDebt";
        readonly outputs: readonly [];
        readonly stateMutability: "nonpayable";
        readonly type: "function";
    }, {
        ...
        readonly outputs: readonly [{
            readonly internalType: "uint256";
            readonly name: "makerCollateral";
            readonly type: "uint256";
        }, {
            readonly internalType: "uint256";
            readonly name: "makerDebt";
            readonly type: "uint256";
        }, {
            readonly internalType: "uint256";
            readonly name: "compoundCollateral";
            readonly type: "uint256";
        }, {
            readonly internalType: "uint256";
            readonly name: "compoundDebt";
            readonly type: "uint256";
        }];
        readonly stateMutability: "nonpayable";
        readonly type: "function";
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): LidoLev;
}
