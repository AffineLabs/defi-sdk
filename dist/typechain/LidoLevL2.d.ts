...
export interface LidoLevL2Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setLeverage", values: [PromiseOrValue<BigNumberish>]): string;
...
export interface LidoLevL2 extends BaseContract {
    ...
    functions: {
        ...
        setLeverage(_leverage: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setLeverage(_leverage: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
