...
export interface CompoundV3StrategyInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "claimAndSellRewards", values: [PromiseOrValue<BigNumberish>]): string;
...
export interface CompoundV3Strategy extends BaseContract {
    ...
    functions: {
        ...
        claimAndSellRewards(minAssetsFromReward: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        balanceOfAsset(overrides?: CallOverrides): Promise<BigNumber>;
        cToken(overrides?: CallOverrides): Promise<string>;
        claimAndSellRewards(minAssetsFromReward: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
