...
export interface SingleStrategyWithdrawalEscrowInterface extends utils.Interface {
    functions: {
        ...
        "lastResolvedUTCTime()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "asset" | "canWithdraw" | "currentEpoch" | "epochInfo" | "getAssets" | "lastResolvedUTCTime" | "redeem" | "registerWithdrawalRequest" | "resolveDebtShares" | "userDebtShare" | "vault" | "withdrawableAssets" | "withdrawableShares"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "lastResolvedUTCTime", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "lastResolvedUTCTime", data: BytesLike): Result;
...
export interface SingleStrategyWithdrawalEscrow extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SingleStrategyWithdrawalEscrowInterface;
    ...
    functions: {
        ...
        lastResolvedUTCTime(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        lastResolvedUTCTime(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        redeem(user: PromiseOrValue<string>, epoch: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
